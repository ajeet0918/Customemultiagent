...
const channels = ['state', 'save-provider', 'delete-provider', 'models', 'save-agent', 'delete-agent', 'add-project', 'remove-project', 'files', 'read-file', 'reveal-project', 'delete-conversation', 'export-conversation', 'approve', 'stop', 'external', 'chat'];
